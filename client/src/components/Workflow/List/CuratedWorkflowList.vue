...
<template>
    <div id="curated-workflows-list" class="workflows-list">
        ...
        <div v-else-if="loadError" class="workflow-list-alert">
            <BAlert id="curated-workflows-error" variant="danger" show>
                <p>{{ loadError }}</p>
        ...
        <div v-else-if="source === 'preparing'" class="workflow-list-alert">
            <BAlert id="curated-workflows-preparing" variant="info" show>
                <p>{{ message }}</p>
        ...
        <div v-else-if="source === 'unavailable'" class="workflow-list-alert">
            <BAlert id="curated-workflows-unavailable" variant="warning" show>
                <p>{{ message }}</p>
                <p>
        ...
        <div v-else-if="!overlay && noItems" class="workflow-list-alert">
            <BAlert id="curated-workflows-empty" variant="info" show>
        ...
        <span v-else-if="!overlay && (noResults || hasInvalidFilters)" class="workflow-list-alert">
            <BAlert v-if="!hasInvalidFilters" id="no-curated-workflow-found" variant="info" show>
            ...
            <BAlert v-else id="no-curated-workflow-found-invalid" variant="danger" show>
