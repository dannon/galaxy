...
update-dependencies:  ## update pinned and dev dependencies
	$(IN_VENV) ./lib/galaxy/dependencies/update.sh

update-and-commit-dependencies: ## update and commit pinned and dev dependencies
	$(IN_VENV) ./lib/galaxy/dependencies/update.sh -c
