...
class DataManager(BaseUIController):
    ...
    def jobs_list(self, trans, **kwd):
        ...
        if data_manager is None:
            return {"message": "Invalid Data Manager (%s) was requested" % data_manager_id, "status": "error"}
        jobs = []
    ...
    def job_info(self, trans, **kwd):
        ...
        if not job:
            return {"message": "Invalid job (%s) was requested" % job_id, "status": "error"}
    ...
    def tool_data_table_info_1(self, trans, **kwd):
        ...
        if data_table is None:
            return {"message": "Invalid data table '%s' was requested." % data_table_name, "status": "error"}
        return {
            "dataTable": {
    ...
    def tool_data_table_items(self, trans, **kwd):
        ...
        if data_table is None:
            return {"data": data, "message": "Invalid Data table (%s) was requested" % table_name, "status": "error"}
