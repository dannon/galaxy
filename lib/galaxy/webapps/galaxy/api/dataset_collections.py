...
from galaxy.webapps.base.controller import BaseAPIController, UsesLibraryMixinItems
...
class DatasetCollectionsController(
    ...
    def contents(self, trans, hdca_id, parent_id, instance_type="history", limit=None, offset=None, **kwds):
        ...
        hdca = svc.get_dataset_collection_instance(trans, id=hdca_id, check_ownership=True, instance_type=instance_type)
