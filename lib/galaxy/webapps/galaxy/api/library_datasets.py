...
from galaxy.managers import base as managers_base, folders, lddas, library_datasets, roles
                ...
                if is_composite:
                    ...
                    try:
                        ...
                        raise exceptions.InternalServerError(
                            "Unable to add composite parent to temporary library download archive. " + util.unicodify(e)
                        )
                    ...
                    for fpath in flist:
                        ...
                        try:
                            ...
                            log.exception("Unable to add %s to temporary library download archive %s", fname, outfname)
                            raise exceptions.InternalServerError(
                                "Unable to add dataset to temporary library download archive . " + util.unicodify(e)
                            )
                else:
                    try:
