    ...
    def __decode_id(self, trans, encoded_id, object_name=None):
        ...
        try:
            ...
            raise exceptions.MalformedId(
                "Malformed %s id specified, unable to decode." % object_name if object_name is not None else ""
            )
        except ValueError:
            raise exceptions.MalformedId(
                "Wrong %s id specified, unable to decode." % object_name if object_name is not None else ""
            )
