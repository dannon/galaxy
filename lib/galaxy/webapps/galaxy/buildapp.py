...
def populate_api_routes( webapp, app ):
    ...
    webapp.mapper.connect( '/api/tools/{id:.+?}/tours', action='tours', controller="tools" )
    webapp.mapper.connect( '/api/tools/{id:.+?}/tours/{tour_id:.+?}', action='tour_by_id', controller="tools" )
