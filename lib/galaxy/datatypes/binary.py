...
class BamNative(CompressedArchive):
    ...
    def groom_dataset_content(self, file_name):
        ...
        sort_args.extend(
            ["-@%s" % slots, file_name, "-T", tmp_sorted_dataset_file_name_prefix, "-O", "BAM", "-o", sorted_file_name]
        )
        try:
...
class Loom(H5):
    ...
    MetadataElement(
        name="creation_date", default=None, desc="creation_date", readonly=True, visible=True, no_value=None
    )
    MetadataElement(
...
class Biom2(H5):
    ...
    MetadataElement(
        name="format_version", default=None, desc="format-version", readonly=True, visible=True, no_value=None
    )
    ...
    MetadataElement(
        name="creation_date", default=None, desc="creation date", readonly=True, visible=True, no_value=None
    )
    MetadataElement(
        name="nnz",
        default=-1,
