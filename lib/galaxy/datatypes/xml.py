...
class Dzi(GenericXml):
    ...
    MetadataElement(
        name="format", desc="File format of the tiles", default=None, readonly=True, visible=True, no_value=None
    )
    MetadataElement(name="tile_size", desc="Size of tiles", default=None, readonly=True, visible=True, no_value=None)
    # Collection elements.
    MetadataElement(
        name="max_level",
        desc="Max pyramid level",
        default=None,
        readonly=True,
        optional=True,
        visible=True,
    ...
    MetadataElement(
        name="quality", desc="Quality", default=None, readonly=True, optional=True, visible=True, no_value=None
    )
    # Image elements.
    MetadataElement(
        name="height", desc="Size height", default=None, readonly=True, optional=True, visible=True, no_value=None
    )
    MetadataElement(
        name="overlap",
    ...
    MetadataElement(
        name="width", desc="Size width", default=None, readonly=True, optional=True, visible=True, no_value=None
    )
