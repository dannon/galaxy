                    ...
                    if can_process_datatype:
                        if dtype is not None:
                            ...
                            if ok:
                                ...
                                if datatype_class is None:
                                    try:
                                        ...
                                        self.log.debug(
                                            "Retrieved datatype module {}:{} from the datatype registry for extension {}.".format(
                                                str(datatype_module), datatype_class_name, extension
                                            )
                                        )
                                    except Exception:
                            ...
                            try:
                                ...
                                self.log.debug(
                                    "Retrieved datatype module {} from type_extension {} for extension {}.".format(
                                        str(datatype_class.__name__), type_extension, extension
                                    )
                                )
                            except Exception:
                                self.log.exception(
                        ...
                        if ok:
                            if not deactivate:
                                ...
                                for composite_file in elem.findall("composite_file"):
                                    ...
                                    if name is None:
                                        self.log.warning(
                                            "You must provide a name for your composite_file (%s)." % composite_file
                                        )
                                ...
                                for auto_compressed_type in auto_compressed_types:
                                    ...
                                    self.converters.append(
                                        (
                                            "%s_to_uncompressed.xml" % auto_compressed_type,
