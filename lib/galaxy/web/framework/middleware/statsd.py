...
class StatsdMiddleware:
    ...
    def __init__(self, application, statsd_host, statsd_port, statsd_prefix, statsd_influxdb):
        self.application = application
        self.galaxy_stasd_client = GalaxyStatsdClient(statsd_host, statsd_port, statsd_prefix, statsd_influxdb)
    ...
    def __call__(self, environ, start_response):
        ...
        try:
            ...
            self.galaxy_stasd_client.timing("sql." + page, sum(times) * 1000.0)
