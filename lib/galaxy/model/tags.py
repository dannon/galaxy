...
class GalaxyTagHandler(TagHandler):
    def __init__(self, sa_session):
        ...
        self.item_tag_assoc_info["History"] = ItemTagAssocInfo(
            model.History, model.HistoryTagAssociation, model.HistoryTagAssociation.table.c.history_id
        )
        ...
        self.item_tag_assoc_info["Page"] = ItemTagAssocInfo(
            model.Page, model.PageTagAssociation, model.PageTagAssociation.table.c.page_id
        )
