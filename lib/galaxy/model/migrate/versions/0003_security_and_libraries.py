...
Index(
    "ix_liitp_library_item_info_template_id", LibraryItemInfoTemplatePermissions_table.c.library_item_info_template_id
)
...
Index(
    "ix_lfita_library_item_info_template_id", LibraryFolderInfoTemplateAssociation_table.c.library_item_info_template_id
)
...
LibraryItemInfo_table = Table(
    ...
    Column(
        "library_item_info_template_id", Integer, ForeignKey("library_item_info_template.id"), nullable=True, index=True
    ),
)
