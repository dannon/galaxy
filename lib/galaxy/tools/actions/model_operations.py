...
class ModelOperationToolAction(DefaultToolAction):
    ...
    def execute(
        ...
        **kwargs
        ...
        self._produce_outputs(
            trans, tool, out_data, output_collections, incoming=incoming, history=history, tags=preserved_tags
        )
    ...
    def _produce_outputs(self, trans, tool, out_data, output_collections, incoming, history, tags):
        ...
        tool.produce_outputs(
            trans, out_data, output_collections, incoming, history=history, tags=tags, tag_handler=tag_handler
        )
