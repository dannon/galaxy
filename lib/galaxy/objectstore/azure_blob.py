...
class AzureBlobObjectStore(ConcreteObjectStore):
    ...
    def _empty(self, obj, **kwargs):
        if self._exists(obj, **kwargs):
            ...
            raise ObjectNotFound(
                "objectstore.empty, object does not exist: {}, kwargs: {}".format(str(obj), str(kwargs))
            )
    ...
    def _update_from_file(self, obj, file_name=None, create=False, **kwargs):
        if create is True:
            ...
            raise ObjectNotFound(
                "objectstore.update_from_file, object does not exist: {}, kwargs: {}".format(str(obj), str(kwargs))
            )
