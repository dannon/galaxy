...
class DatasetsApiTestCase(ApiTestCase):
    ...
    def test_search_by_tag(self):
        ...
        updated_hda = self._put(f"histories/{self.history_id}/contents/{hda_id}", update_payload).json()
    ...
    def test_display(self):
        ...
        display_response = self._get(
            "histories/{}/contents/{}/display".format(self.history_id, hda1["id"]), {"raw": "True"}
        )
    ...
    def test_update_datatype(self):
        ...
        update_while_incomplete_response = self._put(  # try updating datatype while used as output of a running job
            f"histories/{self.history_id}/contents/{queued_id}", {"datatype": "tabular"}
        )
        ...
        successful_updated_hda_response = self._put(
            f"histories/{self.history_id}/contents/{hda_id}", {"datatype": "tabular"}
        ).json()
        ...
        invalidly_updated_hda_response = self._put(  # try updating with invalid datatype
            f"histories/{self.history_id}/contents/{hda_id}", {"datatype": "invalid"}
        )
