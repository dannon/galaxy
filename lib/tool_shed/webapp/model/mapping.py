...
mapper(
    ...
    properties=dict(
        ...
        reviews=relation(
            RepositoryReview, primaryjoin=(Repository.table.c.id == RepositoryReview.table.c.repository_id)
        ),
        reviewers=relation(
            User,
...
mapper(
    ...
    properties=dict(
        ...
        reviews=relation(
            ...
            primaryjoin=(
                (RepositoryMetadata.table.c.repository_id == RepositoryReview.table.c.repository_id)
...
mapper(
    ...
    properties=dict(
        ...
        repository_metadata=relation(
            ...
            primaryjoin=(
                (RepositoryReview.table.c.repository_id == RepositoryMetadata.table.c.repository_id)
        ...
        component_reviews=relation(
            ComponentReview,
            primaryjoin=(
                (RepositoryReview.table.c.id == ComponentReview.table.c.repository_review_id)
