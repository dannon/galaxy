...
class TestFreebayesRepository(ShedTwillTestCase):
    ...
    def test_0000_create_or_login_admin_user(self):
        ...
        assert galaxy_admin_user is not None, (
            "Problem retrieving user with email %s from the database" % common.admin_email
        )
    ...
    def test_0015_install_freebayes_repository(self):
        ...
        assert "invalid_tools" in installed_repository.metadata, (
