...
class TestRepositoryComponentReviews(ShedTwillTestCase):
    ...
    def test_0000_initiate_users(self):
        ...
        assert test_user_3 is not None, (
            "Problem retrieving user with email %s from the database" % common.test_user_3_email
        )
    ...
    def test_0030_browse_with_other_user(self):
        ...
        review = self.test_db_util.get_repository_review_by_user_id_changeset_revision(
