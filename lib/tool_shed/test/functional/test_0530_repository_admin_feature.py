...
class TestRepositoryAdminRole(ShedTwillTestCase):
    ...
    def test_0015_verify_repository_role_association(self):
        ...
        ), "Repository filtering_0530 is not associated with the filtering_0530_user1_admin role."
    ...
    def test_0025_check_admin_role_name(self):
        ...
        """
        test_user_1 = self.test_db_util.get_user(common.test_user_1_email)
        old_repository_admin_role = self.test_db_util.get_role(
            test_user_1, "filtering_0530_%s_admin" % test_user_1.username
        )
        assert old_repository_admin_role is None, "Admin role filtering_0530_user1_admin incorrectly exists."
        new_repository_admin_role = self.test_db_util.get_role(
            test_user_1, "renamed_filtering_0530_%s_admin" % test_user_1.username
        )
